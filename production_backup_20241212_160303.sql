...
CREATE POLICY "Users can create their own votes" ON "public"."votes" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their own votes" ON "public"."votes" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
